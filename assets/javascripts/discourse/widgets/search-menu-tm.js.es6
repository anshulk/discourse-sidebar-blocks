...
export default createWidget('search-menu-tm', {
  ...
  panelContents() {
    ...
    const results = [
      h('div.search-input.tm', searchInput),
      // this.attach('search-context-tm', {
      //   contextEnabled,
    ...
    if (searchData.term && !searchData.loading) {
      results.push(this.attach('search-menu-results-tm', {
  ...
  html(attrs) {
    ...
    return this.attach('menu-panel-tm', { maxWidth: 500, contents: () => this.panelContents() });
  },
